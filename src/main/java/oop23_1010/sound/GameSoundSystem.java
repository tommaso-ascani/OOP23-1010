...
public final class GameSoundSystem {
    ...
    // throw new IllegalArgumentException("Volume range must be [0.0, 1.0].
    // Provided: " + value);
    // }
    // masterVolume = value;
    ...
    // /**
    // * Set the duration of a specific sound. This allows trimming a sound
    // possible.
    // * This method does nothing if the specified duration is greater than the
    // * original
    // * sound duration.
    // *
    ...
    // throw new IllegalArgumentException(sound + " is not present in sound
    // system.");
    // }
    // }
    ...
    // throw new IllegalArgumentException(sounds + " are not present in sound
    // system.");
    // }
    // }
    ...
    // private static boolean mediaPlayerStatusEquals(final MediaPlayer mediaPlayer,
    // final MediaPlayer.Status status) {
    // return Objects.nonNull(mediaPlayer) &&
    // mediaPlayer.getStatus().equals(status);
    // }

    // private static void acceptIfMediaPlayerNotNull(final Consumer<MediaPlayer>
    // consumer,
    ...
    // return Double.compare(value, MIN_VOLUME) >= 0 && Double.compare(value,
    // MAX_VOLUME) <= 0;
    // }

    // private static Map<String, Pair<Media, Optional<Duration>>> loadSounds() {
    // final File jarFile = new File(
    // GameSoundSystem.class.getProtectionDomain().getCodeSource().getLocation().getPath());
    ...
    // private static Map<String, Pair<Media, Optional<Duration>>>
    // jarLoadSounds(final File jarFile) {
    // final JarFile jar;
    // try {
    ...
    // final Enumeration<JarEntry> entries = jar.entries(); // Returns all jar
    // entries.
    ...
    // justification = "requireNonNull is used.")
    // private static Map<String, Pair<Media, Optional<Duration>>> ideLoadSounds() {
    // final Map<String, Pair<Media, Optional<Duration>>> copyMap = new HashMap<>();
    // final URL url =
    // Objects.requireNonNull(GameSoundSystem.class.getResource("/music"));
    // try {
